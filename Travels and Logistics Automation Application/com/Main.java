...
public class Main {
    ...
    private static boolean displayCompanyLogo() {
        try (BufferedReader reader = new BufferedReader(new FileReader("F:\\Logo\\ABC TEXT FILE.txt"))) {
            String line;
            ...
            switch (choice) {
                ...
                case 2:
                    if (userService.login() != null) {
                        travels.showMenuOptions2(); // Show travel options after successful login
                    } else {
